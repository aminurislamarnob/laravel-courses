...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('courses', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('level')->default(0)->comment('0=Beginner, 1=Intermediate, 2=Advanced');
