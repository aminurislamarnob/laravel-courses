        ...
        <div class="container mx-auto">
            <nav class="flex mt-0">
                <ol role="list" class="flex items-center space-x-0.5">
                    <li>
                        <div class="-m-1">
                            <a href="{{route('home.index')}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> Home </a>
                        </div>
                    </li>
                    <li>
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <div class="-m-1">
                                <a href="{{route('single.course', $course->slug)}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none focus:ring-2 focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> Laravel </a>
                            </div>
                        </div>
                    </li>
                </ol>
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    ...
                    @if(count($course->reviews) > 0)
                        ...
                        <div class="bg-white p-6">
                            <h2 class="font-bold text-lg">{{ $review->user->name }}</h2>
                            <p>{{ $review->comment }}</p>
                        </div>
                        @endforeach
                    @else        
                        ...
                        <div class="space-y-4 p-6">
                            ...
                            <div class="space-y-4 pb-2">
                                ...
                                <div class="text-sm px-7">
                                    <p class="text-gray-500 text-center">{{$author->description}}</p>
                                </div>
                            </div>
                            @endforeach
                        </div>
